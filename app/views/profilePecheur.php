...
<body class="antialiased pb-32">
    ...
    <main class="max-w-4xl mx-auto px-6 -mt-16 relative z-10">
        ...
        <div class="flex flex-col items-center text-center mb-10">
            <div class="relative">
                <img src="<?php echo $pecheur->getPhotoPecheur() ?>" class="w-28 h-28 rounded-[35px] border-4 border-[#02040a] shadow-2xl object-cover">
            ...
            <p class="text-slate-500 text-[10px] font-bold uppercase tracking-widest mt-1"><?= $pecheur->getRegion() ?></p>
        </div>
