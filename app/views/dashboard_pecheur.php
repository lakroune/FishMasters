...
<body class="antialiased pb-24">
    ...
    <main class="max-w-6xl mx-auto px-6 pt-32 space-y-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <button onclick="window.location.href=<?= PATH_ROOT ?>/prise" class="bg-cyan-500 text-black px-6 py-3 rounded-2xl font-black uppercase text-[10px] tracking-widest shadow-[0_10px_20px_rgba(6,182,212,0.3)]">
                Lancer un Prise <i class="fa-solid fa-broadcast-tower ml-2"></i>
            </button>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="ultra-glass p-6 rounded-[35px] stat-card md:col-span-2 flex items-center justify-between">
                <div>
                    ...
                    <h2 class="text-5xl font-black italic text-cyan-500">
                        <?php if ($classement) echo $classement->getRank();
                        else echo "+99";
                        ?> </h2>
                    <p class="text-[10px] font-bold text-green-500 mt-2 uppercase"><i class="fa-solid fa-caret-up"></i> </p>
                </div>
            ...
            <div class="ultra-glass p-6 rounded-[35px] stat-card">
                ...
                <h2 class="text-3xl font-black italic"><?= $score->getTotalPoints(); ?></h2>
            ...
            <div class="ultra-glass p-6 rounded-[35px] stat-card">
                ...
                <h2 class="text-3xl font-black italic"><?= count($prises) ?></h2>
