                ...
                <div class="ultra-glass rounded-[35px] overflow-hidden group border border-white/5">
                    ...
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-4">
                            <div>
                                <h4 class="text-lg font-black uppercase italic"><?= ""//$p->espece ?></h4>
                                <p class="text-[10px] text-slate-500 font-bold uppercase tracking-tight">Pêché par <span class="text-cyan-500"><?=""// $p->nom_pecheur ?></span></p>
                            </div>
        ...
        <section class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2 ultra-glass p-8 rounded-[40px] space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between p-4 rounded-2xl bg-white/5 hover:bg-white/10 transition-all border border-transparent hover:border-cyan-500/30">
                        ...
                        <p class="text-sm font-black <?= ($index == 0) ? 'text-cyan-400' : 'text-white' ?> italic"><?= ""// $rank->getTotalPoints" ?> PTS</p>
                    </div>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div class="ultra-glass p-8 rounded-[40px] text-center border-b-4 border-cyan-500">
                    ...
                    <h2 class="text-4xl font-black italic"><?= count($top_pecheurs) * 123 ?></h2> <p class="text-[8px] text-cyan-500 font-bold uppercase mt-2">Membres en ligne</p>
                </div>
            </div>
        </section>
    </main>

    <nav class="fixed bottom-6 left-1/2 -translate-x-1/2 z-[100] ultra-glass px-8 py-4 rounded-full border border-white/10 shadow-2xl flex items-center gap-12">
        <a href="#" class="text-cyan-500 text-lg"><i class="fa-solid fa-house"></i></a>
        <a href="#" class="text-slate-500 hover:text-white transition-colors text-lg"><i class="fa-solid fa-ranking-star"></i></a>
        <a href="#" class="text-slate-500 hover:text-white transition-colors text-lg"><i class="fa-solid fa-magnifying-glass"></i></a>
    </nav>
